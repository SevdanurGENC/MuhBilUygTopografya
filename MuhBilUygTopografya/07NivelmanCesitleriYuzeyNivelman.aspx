<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="07NivelmanCesitleriYuzeyNivelman.aspx.cs" Inherits="m07NivelmanCesitleriYuzeyNivelman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        <tr>
            <td>
                <strong>
                <span class="style11">NIVELMAN ÇESITLERI
                </span>
                <span class="style7">
                <br />
                </span>
                ...
                <table bgcolor="#D1D4DA" border="2" class="style10">
                    <tr>
                        ...
                        <td bgcolor="#D1D4DA" class="style29" rowspan="2">
                    ...
                    <tr>
                        <td colspan="10">
                            <asp:Button ID="Button2" runat="server" Font-Bold="True" 
                                onclick="Button2_Click" Text="Rapor Al ..." Width="708px" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <br />
                <br />
                <span class="style8"><strong>KARELER AGI ILE YÜZEY NIVELMANI</strong></span>
                <br />
                <br />
                Araziye çakilan kareler aginda okumalar yapilir. Arazi yüzeyi engelsiz ve düzgün 
                oldugunda uygulanabilir. Özellikle arazi tesviyesi yapilacak alanlarda 
                uygulanir.
                <br />
                <br />
                <asp:Image ID="Image2" runat="server" 
                    ImageUrl="~/Images/07KarelerAgiYuzey.png" />
                <br />
                <br />
                <br />
            </td>
